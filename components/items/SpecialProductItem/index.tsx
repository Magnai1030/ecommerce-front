...
const SpecialProductItem: FC<Props> = ({ data }) => {
  return (
    <div className="border-2 w-full border-gray-500 hover:border-orange-500 transition-all rounded-lg flex p-4 flex-col relative mb-6 place-items-center">
